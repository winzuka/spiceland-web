  ...
  const products = [
    {
      ...
      price: "$12.99",
      description:
        "Premium true cinnamon from Sri Lanka with sweet, delicate flavor",
      benefits: [
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-green-100 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-green-700 max-w-3xl mx-auto leading-relaxed">
            Discover our carefully curated collection of organic spices, sourced
            from the
            {`world's`} finest growing regions and processed to preserve their
            natural flavors.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-green-800 mb-6">
              Why Choose Spiceland?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our commitment to quality, sustainability, and authenticity sets
              us apart in the spice industry.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Certified organic spices grown without pesticides or artificial
                additives.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Small batch processing ensures maximum freshness and flavor
                potency.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Direct relationships with farmers ensure authenticity and fair
                pricing.
              </p>
            </div>
      ...
      <section className="py-20 bg-green-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Our spice experts are here to help you find the perfect spices for
            your needs.
          </p>
