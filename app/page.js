...
export default function Home() {
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-green-800 mb-6">About Spiceland</h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Spiceland was founded with a passion for bringing the world's finest organic spices 
                directly to your kitchen. We work closely with local farmers and suppliers to ensure 
                that every spice meets our high standards for quality, purity, and sustainability.
              </p>
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                Our commitment to organic farming practices and traditional processing methods 
                ensures that you receive spices that are not only flavorful but also retain 
                their natural nutritional benefits.
              </p>
              <Link 
                href="/about" 
      ...
      <section className="py-20 bg-green-50 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-green-800 mb-4">Our Premium Spices</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover our carefully curated selection of organic spices, 
              each one chosen for its exceptional quality and authentic flavor.
            </p>
          </div>
  ...
  {[
    ...
    {
      name: "Turmeric",
      description: "Golden organic turmeric powder with health benefits",
      image: "/turmeric.jpg"
    },
    {
      name: "Cardamom",
      description: "Aromatic green cardamom pods from mountain regions",
      image: "/cardamom.jpg"
    },
    {
      name: "Cloves",
    ...
    {
      name: "Star Anise",
      description: "Distinctive star-shaped spice with licorice notes",
  ...
  <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-white p-6">
    <h3 className="text-xl font-semibold mb-3 text-center">{spice.name}</h3>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From sourcing to processing, we provide comprehensive spice solutions 
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-green-800 mb-3">Quality Assurance</h3>
                <p className="text-gray-600 leading-relaxed">
                  Every batch undergoes rigorous quality testing to ensure purity, 
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-green-800 mb-3">Custom Packaging</h3>
                <p className="text-gray-600 leading-relaxed">
                  Flexible packaging options from bulk quantities to retail-ready 
                  portions, tailored to your specific needs.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-green-800 mb-3">Global Sourcing</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Efficient logistics and packaging ensure your spices arrive fresh 
      ...
      <section className="py-20 bg-green-600 text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of satisfied customers who trust Spiceland for their culinary adventures.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/contact" 
